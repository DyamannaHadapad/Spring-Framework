...
<body>
	...
	<h1 style="color: blue;" align="center">Information of Bag</h1>
	...
	<form action="send" method="post">
		...
		Color <input type=" text" name="color" value="${dto.color}"><br>
		Price <input type=" text" name="price" value="${dto.price}"><br>
		Quantity <input type=" text" name=quantity value="${dto.quantity}"><br>
